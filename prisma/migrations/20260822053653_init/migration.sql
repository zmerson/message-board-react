...
CREATE TABLE "_BoardToTag" (
    ...
    CONSTRAINT "_BoardToTag_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- AddForeignKey
ALTER TABLE "_BoardToTag" ADD CONSTRAINT "_BoardToTag_A_fkey" FOREIGN KEY ("A") REFERENCES "Board"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_BoardToTag" ADD CONSTRAINT "_BoardToTag_B_fkey" FOREIGN KEY ("B") REFERENCES "Tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
